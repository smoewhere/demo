...
public class TestKafka {
  ...
  public void testSend(){
    KafkaTemplate<String, String> template = createTemplate2();
    template.setDefaultTopic("topic1");
    template.sendDefault("lk");
    template.flush();
    logger.info("[TestKafka.testSend] end send");
  }
  ...
  private KafkaTemplate<String, String> createTemplate2() {
    Map<String, Object> senderProps = senderProps();
